% Same test/driver file as getUserGuessV5, ensuring whether any comments or changes
% have affected the current program.
...
target = [3, 4];  % Target coordinate to be guessed
gridSize = 5;  % Grid size for the guessing game
...
target = [3, 4]; 
gridSize = 5;  
guessHistory = getUserGuessV5(gridSize, target);
disp('Guess History:');
disp(guessHistory);
